        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 md:p-12">
          <form className="space-y-10" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <label className="relative cursor-pointer group">
                  <input type="radio" name="style" value="friendly" className="sr-only peer" checked={style === 'friendly'} onChange={() => setStyle('friendly')} />
                  <div className="border-2 border-gray-200 rounded-xl p-6 peer-checked:border-blue-500 peer-checked:bg-blue-50 hover:border-blue-300 transition-all duration-200 group-hover:shadow-md">
                    <div className="flex items-start space-x-4">
                      <div className="flex-shrink-0">
                ...
                <label className="relative cursor-pointer group">
                  <input type="radio" name="style" value="professional" className="sr-only peer" checked={style === 'professional'} onChange={() => setStyle('professional')} />
                  <div className="border-2 border-gray-200 rounded-xl p-6 peer-checked:border-blue-500 peer-checked:bg-blue-50 hover:border-blue-300 transition-all duration-200 group-hover:shadow-md">
                    <div className="flex items-start space-x-4">
                      <div className="flex-shrink-0">
                ...
                <label className="relative cursor-pointer group">
                  <input type="radio" name="style" value="pressure" className="sr-only peer" checked={style === 'pressure'} onChange={() => setStyle('pressure')} />
                  <div className="border-2 border-gray-200 rounded-xl p-6 peer-checked:border-blue-500 peer-checked:bg-blue-50 hover:border-blue-300 transition-all duration-200 group-hover:shadow-md">
                    <div className="flex items-start space-x-4">
                      <div className="flex-shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-red-500" viewBox="0 0 24 24" fill="currentColor">
                ...
                <label className="relative cursor-pointer group">
                  <input type="radio" name="style" value="guided" className="sr-only peer" checked={style === 'guided'} onChange={() => setStyle('guided')} />
                  <div className="border-2 border-gray-200 rounded-xl p-6 peer-checked:border-blue-500 peer-checked:bg-blue-50 hover:border-blue-300 transition-all duration-200 group-hover:shadow-md">
                    <div className="flex items-start space-x-4">
                      <div className="flex-shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-green-500" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
              ...
              <button type="button" className="border-2 border-gray-300 hover:border-gray-400 text-gray-700 font-semibold py-4 px-8 rounded-xl transition-all duration-200 hover:bg-gray-50 flex items-center justify-center space-x-2" onClick={() => { setDomain(null); setStyle(null); }}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-10.707a1 1 0 00-1.414-1.414L10 8.586 7.707 6.293a1 1 0 10-1.414 1.414L8.586 10l-2.293 2.293a1 1 0 101.414 1.414L10 11.414l2.293 2.293a1 1 0 001.414-1.414L11.414 10l2.293-2.293z" clipRule="evenodd" />
                </svg>
                <span>取消</span>
              </button>
            </div>
